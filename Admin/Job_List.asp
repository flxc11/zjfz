...
<th colspan="2" class="Right">招聘职位<a href="#" onclick="top.CreateNewTab('Job_ContentAdd.asp?ClassID=<%=ClassID%>','Job_ContentAdd','添加职位')">[+]</a></th>
<th width="10%" class="Right">发布日期</th>
...
<td colspan="2" class="Right"><a href="Job_ContentEdit.asp?ID=<%=Rs("ID")%>&ClassID=<%=Rs("ClassID")%>"><%=Rs("Jobs")%></a></td>
