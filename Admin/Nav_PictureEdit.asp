...
If Action="Save" Then
	...
	Conn.Close
	Set Conn=Nothing
	Response.Write("<script>alert('\u56fe\u7247\u5185\u5bb9\u4fee\u6539\u64cd\u4f5c\u6210\u529f\u3002');window.location.href='Nav_Picture.asp';</script>")
	Response.End()
End If
%>
...
<tr>
<td style="border-bottom:solid 1px #dde4e9;height:30px;width:80%">当前位置：<a href="Nav_Picture.asp">图片内容维护</a> >> 编辑图片内容</td>
...
<tr>
<th colspan="4">编辑图片内容</th>
</tr>
<tr>
<td class="Right" width="12%" align="right">图片内容名称：</td>
<td class="Right">
<%if Request.Cookies("CNVP_CMS2")("SiteVersion")="Chiness" then%>
<div class="float_left_300txt"><input type="text" id="NavTitle" name="NavTitle" value="<%=NavTitle%>" class="Input300px"/></div><div class="float_left_25">*(必填)</div>
<%end if%>
<%if Request.Cookies("CNVP_CMS2")("SiteVersion")="English" then%>
<div class="float_left_300txt"><input type="text" id="EnNavTitle" name="EnNavTitle" value="<%=EnNavTitle%>" class="Input300px"/></div><div class="float_left_25">*(必填)</div>
<%end if%>
...
<tr>
<td class="Right" width="12%" align="right">图片内容说明：</td>
<td colspan="3" class="Right"><input type="text" id="NavRemark" name="NavRemark" value="<%=NavRemark%>" class="Input300px"/></td>
</tr>
<tr>
<td class="Right" width="12%" align="right">图片内容图片：</td>
<td width="43%"><div class=" float_left_300txt"><input type="text" id="NavPicture" name="NavPicture" readonly="readonly" value="<%=NavPicture%>" class="Input300px"></div><div class="float_left_25">*(必填)</div></td>
<td colspan="2"><input type="button" value="浏览图片" class="Button" onclick="OpenImageBrowser('NavPicture');"/></td>
</tr>
<tr>
<td class="Right" width="12%" align="right" valign="top">图片详细内容：</td>
<td colspan="3">
<%if Request.Cookies("CNVP_CMS2")("SiteVersion")="Chiness" then%>
...
<tr>
<td class="Right" width="12%" align="right">导航条状态：</td>
...
<tr>
<td class="Right" width="12%" align="right">&nbsp;</td>
