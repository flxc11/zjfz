...
<form id="form1" name="form1" method="post" action="Pro_ContentListIn.asp?ShowType=<%=ShowType%>">
...
<td width="75%"><input type="submit" value="查 找" class="Button"> <input type="button" value="返 回" class="Button" onClick="window.location.href='Pro_ContentListIn.asp?ShowType=<%=ShowType%>'"></td>
</tr>
</table>
</form>
</td>
